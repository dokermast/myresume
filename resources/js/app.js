...
Vue.component('apps-component', require('./components/AppsComponent.vue').default);
Vue.component('contact-component', require('./components/ContactComponent.vue').default);
Vue.component('copyright-component', require('./components/CopyrightComponent.vue').default);
